        ...
        <div  className='w-full min-h-full bg-[#FFFCEF]'>
            ...
            <div className='container mx-auto px-4 pt-6 pb-[70px] relative z-10 '>
                ...
                <header className='flex justify-between items-center mb-16'>
                    ...
                    <button className="bg-gradient-to-r from-[#FF9324] to-[#e99a4b] 
        ...
        <div className='w-full min-h-full relative z-10  bg-[#FFFCEF]'>
                <div>
                    <section className="flex items-center justify-center ">
                        ...
                        className="w-[80vw] rounded-lg bg-[#FFFEF8] p-6  shadow-sm hover:shadow-lg shadow-amber-200 transition border border-amber-200"
                        />
                    </section>
                </div>
                ...
                <div className="container mx-auto px-4 pt-10 pb-20">
                    ...
                    <div className="flex flex-col items-center gap-8">
                        ...
                        {APP_FEATURES.slice(0, 3).map((feature) => (
                            <div
                            key={feature.id}
                            className="bg-[#FFFEF8] p-6 rounded-xl shadow-sm hover:shadow-lg shadow-amber-200 transition border border-amber-200"
                            >
