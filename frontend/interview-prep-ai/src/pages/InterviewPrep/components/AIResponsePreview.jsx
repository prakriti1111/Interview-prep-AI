            ...
            <div className='text-[14px] prose prose-slate dark:prose-invert max-w-none' >
                <ReactMarkdown
                    ...
                    components={{
                        ...
                        p({children}) {
                            return <p className='mb-10 leading-5'>{children}</p>;
                        },
                        strong({children}) {
                        ...
                        blackqoute({children}) {
                            return <blackqoute className='border-l-4 border-gray-200 pl-4 italic my-4'>{children}</blackqoute>;
                        },
                        h1({children}) {
                        ...
                        h4({children}) {
                            return <h4 className='text-base font-bold mt-6 mb-4'>{children}</h4>
                        },
                        a({children , href}) {
    ...
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
        ...
        >
          ...
          {copied && (
            <span className="absolute -top-8 reight-0 bg-black text-white text-xs rounded-md px-2 py-1 opacity-80 group-hover:opacity-100 transition ">
                Copied!
            </span>
          )}
        </button>
