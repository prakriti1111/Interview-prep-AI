...
const SummaryCard = ({
  ...
  return (
    <>
        <div className='bg-white border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-[#e7b8ed] relative group'
        onClick={onSelect}
        >
            ...
            style={{background: colors.bgcolor, 
                ...
                <button className=' hidden group-hover:flex items-center gap-2 text-xs text-rose-500 fontmedium bg-rose-50 px-3 py-1 rounded text-nowrap border border-rose-100  hover:border-rose-200 cursor pointer absolute top-0 right-0 '
                    onClick={(e) => {
                        e.stopPropagation();
                        onDelete();
                    }}>
